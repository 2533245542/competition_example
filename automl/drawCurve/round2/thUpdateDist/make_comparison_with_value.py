...
# scp wzhou87@mox.hyak.uw.edu:/gscratch/stf/wzhou87/hyperparameterTuning/round2/thUpdateDist/drawManyCurvesZxqweka0-5/thUpdateDist.csv ../drawCurve/round2/thUpdateDist
## change start

#%% hyperparameters
datasetUsed = ['large', 'small', 'all'][2]
file = 'thUpdateDist.csv'

anchorValue = 3
hyperparameterValues = [1,2,3,4,5,6]
ax1_ylim = [20, 22]
ax2_ylim = [3.0, 4]
