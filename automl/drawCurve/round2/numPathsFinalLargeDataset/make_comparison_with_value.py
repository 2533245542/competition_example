...
# scp wzhou87@mox.hyak.uw.edu:/gscratch/stf/wzhou87/hyperparameterTuning/round2/numPathsFinalLargeDataset/drawManyCurvesZxqweka0-5/numPathsFinalLargeDataset.csv ../drawCurve/round2/numPathsFinalLargeDataset
## change start

#%% hyperparameters
datasetUsed = ['large', 'small', 'all'][2]
file = 'numPathsFinalLargeDataset.csv'

anchorValue = 3
hyperparameterValues = [1,2,3,4,5]
ax1_ylim = [20, 22]
ax2_ylim = [3.0, 4]
