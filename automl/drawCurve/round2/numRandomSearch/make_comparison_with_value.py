...
# scp wzhou87@mox.hyak.uw.edu:/gscratch/stf/wzhou87/hyperparameterTuning/round2/numRandomSearch/drawManyCurvesZxqweka0-5/numRandomSearch.csv ../drawCurve/round2/numRandomSearch

## change start

#%% hyperparameters
datasetUsed = ['large', 'small', 'all'][2]
file = 'numRandomSearch.csv'

anchorValue = 35
hyperparameterValues = [20, 25, 30, 35, 40, 45]
ax1_ylim = [20, 22]
ax2_ylim = [3.0, 4]
