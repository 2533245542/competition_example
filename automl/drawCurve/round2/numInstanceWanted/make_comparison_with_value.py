...
# scp wzhou87@mox.hyak.uw.edu:/gscratch/stf/wzhou87/hyperparameterTuning/round2/numInstanceWanted/drawManyCurvesZxqweka0-5/numInstanceWanted.csv ../drawCurve/round2/numInstanceWanted

## change start

#%% hyperparameters
datasetUsed = ['large', 'small', 'all'][2]
file = 'numInstanceWanted.csv'

anchorValue = 3000
hyperparameterValues = [1000,2000,3000,4000,5000,6000]
ax1_ylim = [20, 22]
ax2_ylim = [3.0, 4]
