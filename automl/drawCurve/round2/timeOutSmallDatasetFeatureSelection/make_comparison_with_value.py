...
# scp wzhou87@mox.hyak.uw.edu:/gscratch/stf/wzhou87/hyperparameterTuning/round2/timeOutSmallDatasetFeatureSelection/drawManyCurvesZxqweka0-5/timeOutSmallDatasetFeatureSelection.csv ../drawCurve/round2/timeOutSmallDatasetFeatureSelection
## change start

#%% hyperparameters
datasetUsed = ['large', 'small', 'all'][2]
file = 'timeOutSmallDatasetFeatureSelection.csv'
