...
# scp wzhou87@mox.hyak.uw.edu:/gscratch/stf/wzhou87/hyperparameterTuning/round2/numPathsSmallDataset/drawManyCurvesZxqweka0-5/numPathsSmallDataset.csv ../drawCurve/round2/numPathsSmallDataset
## change start

#%% hyperparameters
datasetUsed = ['large', 'small', 'all'][2]
file = 'numPathsSmallDataset.csv'

anchorValue = 3
hyperparameterValues = [2,3,4,5,6,7]
ax1_ylim = [20, 22]
ax2_ylim = [3.0, 4]
