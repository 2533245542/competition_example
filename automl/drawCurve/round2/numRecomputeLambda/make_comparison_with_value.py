...
# scp wzhou87@mox.hyak.uw.edu:/gscratch/stf/wzhou87/hyperparameterTuning/round2/numRecomputeLambda/drawManyCurvesZxqweka0-5/numRecomputeLambda.csv ../drawCurve/round2/numRecomputeLambda

## change start

#%% hyperparameters
datasetUsed = ['large', 'small', 'all'][2]
file = 'numRecomputeLambda.csv'

anchorValue = 25
hyperparameterValues = [10, 15, 20, 25, 30, 35]
ax1_ylim = [20, 22]
ax2_ylim = [3.0, 4]
