...
# scp wzhou87@mox.hyak.uw.edu:/gscratch/stf/wzhou87/hyperparameterTuning/round2/numRFSearch/drawManyCurvesZxqweka0-5/numRFSearch.csv ../drawCurve/round2/numRFSearch

## change start

#%% hyperparameters
datasetUsed = ['large', 'small', 'all'][2]
file = 'numRFSearch.csv'
