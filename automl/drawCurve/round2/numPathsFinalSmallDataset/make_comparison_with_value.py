...
# scp wzhou87@mox.hyak.uw.edu:/gscratch/stf/wzhou87/hyperparameterTuning/round2/numPathsFinalSmallDataset/drawManyCurvesZxqweka0-5/numPathsFinalSmallDataset.csv ../drawCurve/round2/numPathsFinalSmallDataset
## change start

#%% hyperparameters
datasetUsed = ['large', 'small', 'all'][2]
file = 'numPathsFinalSmallDataset.csv'

anchorValue = 10
hyperparameterValues = [6,8,10,12,14]
ax1_ylim = [20, 22]
ax2_ylim = [3.0, 4]
