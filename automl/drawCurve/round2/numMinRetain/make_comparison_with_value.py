...
# scp wzhou87@mox.hyak.uw.edu:/gscratch/stf/wzhou87/hyperparameterTuning/round2/numMinRetain/drawManyCurvesZxqweka0-5/numMinRetain.csv ../drawCurve/round2/numMinRetain

## change start

#%% hyperparameters
datasetUsed = ['large', 'small', 'all'][2]
file = 'numMinRetain.csv'

anchorValue = 4
hyperparameterValues = [1,2,3,4,5,6,7]
ax1_ylim = [20, 22]
ax2_ylim = [3.0, 4]
