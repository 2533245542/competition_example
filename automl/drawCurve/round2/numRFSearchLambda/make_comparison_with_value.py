...
# scp wzhou87@mox.hyak.uw.edu:/gscratch/stf/wzhou87/hyperparameterTuning/round2/numRFSearchLambda/drawManyCurvesZxqweka0-5/numRFSearchLambda.csv ../drawCurve/round2/numRFSearchLambda

## change start

#%% hyperparameters
datasetUsed = ['large', 'small', 'all'][2]
file = 'numRFSearchLambda.csv'

anchorValue = 10
hyperparameterValues = [4,7,10,13,16,19]
ax1_ylim = [20, 22]
ax2_ylim = [3.0, 4]
